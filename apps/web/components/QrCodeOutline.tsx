export function QrCodeOutline({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      id="en8vaLVY3J11"
      ...
      <g transform="translate(25 25)">
        ...
        <g transform="translate(29.999983 30.000003)">
          <rect
            ...
            rx="0"
            ry="0"
            transform="matrix(1.354791 0 0 1.484848 4.086398 4.086398)"
            fill="none"
            stroke="#00000066"
            strokeWidth="6"
          />
          <rect
            ...
            rx="0"
            ry="0"
            transform="matrix(1.354791 0 0 1.484848 24.086398 24.086399)"
            fill="#00000066"
            strokeWidth="6"
          />
        </g>
