  ...
  return (
    <SkyPage>
      ...
      <section className="panel stack">
        ...
        <p>Eggeo stores a small amount of data on your device, including your last signed-in account profile, selected event, previously loaded game data, saved egg map positions, and pending offline actions, so the app can keep working when internet access is unavailable.</p>
